...
// Clase que representa lo mas abstracto de un personaje y enemigo que tienen en común
class AEntidad
{
private:
...
protected:
	...
	/// @brief Propiedad autocalculada, tiempo que ha de pasar para volver a atacar
	...
	/// @brief Probabilidad entre 0 - 30 que reduce el daño recibido de tipo físico
	float armadura;
	/// @brief Modificador multiplicativo de armadura
	float modificadorArmadura = MULTIPLICADOR_BASE;

	/// @brief Probabilidad entre 0 - 30 que reduce el daño recibido de tipo mágico
	float resistencia;
	...
	AEntidad(float vida, float velocidadMovimiento, float agilidad,
			 ...
			 float danyoCritico, float roboVida, float regeneracionVida, Texture2D textura)
		: vida(vida),
		  velocidadMovimiento(velocidadMovimiento),
		  agilidad(agilidad),
		  velocidadAtaque(velocidadAtaque),
		  danyoFisico(danyoFisico),
		  danyoMagico(danyoMagico),
		  armadura(armadura),
		  resistencia(resistencia),
		  probabilidadCritico(probabilidadCritico),
		  danyoCritico(danyoCritico),
		  roboVida(roboVida),
...

	{
		...
		if (regeneracionVida < REGENERACION_MINIMA)
			regeneracionVida = REGENERACION_MINIMA;
	};
...
public:
	...
	float GetModificadorVelocidadMovimiento() const { return modificadorVelocidadMovimiento; }
	...
	float GetModificadorVelocidadAtaque() const { return modificadorVelocidadAtaque; }
	...
	float GetModificadorProbabilidadCritico() const { return modificadorProbabilidadCritico; }
	...
	float GetModificadorRegeneracionVida() const { return modificadorRegeneracionVida; }
	...
	void SetVelocidadMovimiento(float nuevaVelocidad) { velocidadMovimiento = nuevaVelocidad * modificadorVelocidadMovimiento; }
	
	/// @brief Establece la agilidad base y aplica modificador
	void SetAgilidad(float nuevaAgilidad) { agilidad = nuevaAgilidad * modificadorAgilidad; }
	
	/// @brief Establece la velocidad de ataque base, aplica modificador y recalcula el tiempo de recarga
	...
	void SetDanyoFisico(float nuevoDanyo) { danyoFisico = nuevoDanyo * modificadorDanyoFisico; }
	
	/// @brief Establece el daño mágico base y aplica modificador
	void SetDanyoMagico(float nuevoDanyo) { danyoMagico = nuevoDanyo * modificadorDanyoMagico; }
	
	/// @brief Establece la armadura base y aplica modificador
	void SetArmadura(float nuevaArmadura) { armadura = nuevaArmadura * modificadorArmadura; }
	
	/// @brief Establece la resistencia mágica base y aplica modificador
	void SetResistencia(float nuevaResistencia) { resistencia = nuevaResistencia * modificadorResistencia; }
	
	/// @brief Establece la probabilidad de crítico base y aplica modificador
	void SetProbabilidadCritico(float nuevaProbabilidad) { probabilidadCritico = nuevaProbabilidad * modificadorProbabilidadCritico; }
	
	/// @brief Establece el multiplicador de daño crítico base y aplica modificador
	void SetDanyoCritico(float nuevoMultiplicador) { danyoCritico = nuevoMultiplicador * modificadorDanyoCritico; }
	
	/// @brief Establece el porcentaje de robo de vida base y aplica modificador
	void SetRoboVida(float nuevoRobo) { roboVida = nuevoRobo * modificadorRoboVida; }
	
	/// @brief Establece la regeneración de vida base y aplica modificador
	void SetRegeneracionVida(float nuevaRegeneracion) { regeneracionVida = nuevaRegeneracion * modificadorRegeneracionVida; }
	...
	void SetModificadorVida(float nuevoModificador) { modificadorVida = nuevoModificador; }
	
	/// @brief Establece el modificador de velocidad de movimiento
	void SetModificadorVelocidadMovimiento(float nuevoModificador) { modificadorVelocidadMovimiento = nuevoModificador; }
	
	/// @brief Establece el modificador de agilidad
	void SetModificadorAgilidad(float nuevoModificador) { modificadorAgilidad = nuevoModificador; }
	
	/// @brief Establece el modificador de velocidad de ataque
	void SetModificadorVelocidadAtaque(float nuevoModificador) { modificadorVelocidadAtaque = nuevoModificador; }
	
	/// @brief Establece el modificador de daño físico
	void SetModificadorDanyoFisico(float nuevoModificador) { modificadorDanyoFisico = nuevoModificador; }
	
	/// @brief Establece el modificador de daño mágico
	void SetModificadorDanyoMagico(float nuevoModificador) { modificadorDanyoMagico = nuevoModificador; }
	
	/// @brief Establece el modificador de armadura
	void SetModificadorArmadura(float nuevoModificador) { modificadorArmadura = nuevoModificador; }
	
	/// @brief Establece el modificador de resistencia mágica
	void SetModificadorResistencia(float nuevoModificador) { modificadorResistencia = nuevoModificador; }
	
	/// @brief Establece el modificador de probabilidad de crítico
	void SetModificadorProbabilidadCritico(float nuevoModificador) { modificadorProbabilidadCritico = nuevoModificador; }
	
	/// @brief Establece el modificador de daño crítico
	void SetModificadorDanyoCritico(float nuevoModificador) { modificadorDanyoCritico = nuevoModificador; }
	
	/// @brief Establece el modificador de robo de vida
	void SetModificadorRoboVida(float nuevoModificador) { modificadorRoboVida = nuevoModificador; }
	
	/// @brief Establece el modificador de regeneración de vida
	void SetModificadorRegeneracionVida(float nuevoModificador) { modificadorRegeneracionVida = nuevoModificador; }
