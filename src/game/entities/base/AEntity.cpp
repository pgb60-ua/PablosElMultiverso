...
AEntity::AEntity(Stats stats, const Shape &hitbox, Vector2 position, std::vector<Texture2D *> textures)
    : stats(std::move(stats)), hitbox(hitbox), position(position), textures(textures)
{
